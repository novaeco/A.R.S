...
#define BOARD_LCD_PCLK_ACTIVE_NEG CONFIG_ARS_LCD_PCLK_ACTIVE_NEG
#define BOARD_LCD_HSYNC_IDLE_LOW CONFIG_ARS_LCD_HSYNC_IDLE_LOW
#define BOARD_LCD_VSYNC_IDLE_LOW CONFIG_ARS_LCD_VSYNC_IDLE_LOW
#define BOARD_LCD_DE_IDLE_HIGH CONFIG_ARS_LCD_DE_IDLE_HIGH
