 ...
 *
 * This file contains the necessary functions and configurations to interact
 * with the GT911 touch controller via I2C. It provides initialization and touch
 ...
 *
 * This function initializes a new instance of the GT911 touch driver by
 * configuring the touch screen using the I2C communication protocol.
 *
 * @note The I2C communication should be initialized before calling this
 * function.
 *
 * @param io LCD/Touch panel I/O handle to interface with the I2C bus.
 * @param config Configuration structure with touch screen settings (resolution,
 * GPIO, etc.).
 ...
 *
 * This function reads the touch points detected by the GT911 controller and
 * returns the coordinates of the touch points.
 *
 * @param max_touch_cnt Maximum number of touch points to read.
 * @return A structure containing the coordinates and the number of detected
 * touch points.
 */
 ...
 * controller's I2C interface with specific settings like the device address,
 * SCL frequency, etc.
 */
#define ESP_LCD_TOUCH_IO_I2C_GT911_CONFIG()                                                     \
  {                                                                                             \
    .dev_addr = ESP_LCD_TOUCH_IO_I2C_GT911_ADDRESS, /*!< Set the I2C address                    \
                                                       for the GT911 */                         \
        .scl_speed_hz = 100000,                     /*!< Set the I2C master                     \
                                                                             clock frequency */ \
        .control_phase_bytes =                                                                  \
            1, /*!< Set the number of bytes for the control phase */                            \
        .dc_bit_offset =                                                                        \
            0, /*!< Set the DC bit offset for I2C communication */                              \
        .lcd_cmd_bits = 16, /*!< Set the LCD command bits */                                    \
        .flags = {                                                                              \
          .disable_control_phase =                                                              \
              1, /*!< Disable control phase for I2C communication */                            \
        }                                                                                       \
  }
